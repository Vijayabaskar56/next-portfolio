        ...
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              ...
              >
                <ArrowBigUp className="h-6 w-6 text-black dark:text-white hover:text-green-500 dark:hover:text-green-500 focus:text-green-400 dark:focus:text-green-500" />
